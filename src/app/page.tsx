...
export default function Gateway() {
  ...
  const workshopImages = ["/images/workshop-1.jpeg", "/images/workshop-5.jpeg"];
  ...
  const portals = [
    {
      ...
      icon: GraduationCap,
      description:
        "Empower students and teachers with AI-driven practice for oral exams and interviews.",
      href: "/education",
    ...
    },
    {
      ...
      icon: Sparkles,
      description:
        "Create custom brand ambassadors and interactive avatars for your digital presence.",
      href: "/brands",
    ...
    },
    {
      ...
      icon: Users,
      description:
        "Hands-on training sessions to master digital human technology and implementation strategies.",
      href: "/workshop",
  ...
  return (
    <div className="bg-background">
      ...
      <div
        ref={containerRef}
        className="h-screen w-full relative z-0 overflow-hidden bg-black"
      >
        <motion.div className="relative w-full h-full">
          <div className="absolute inset-0 bg-black/40 z-10" /> {/* Overlay */}
          <iframe
            className="w-full h-full object-cover pointer-events-none scale-150"
            src={`https://www.youtube.com/embed/qj9Mu1uzkmE?autoplay=1&mute=${
              isMuted ? 1 : 0
            }&controls=0&loop=1&playlist=qj9Mu1uzkmE&playsinline=1&rel=0`}
                ...
                <Link href={portal.href} className="block h-full group">
                  <Card className="h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer relative overflow-hidden flex flex-col bg-card rounded-3xl">
                    ...
                    <div className="w-full h-56 overflow-hidden relative bg-gray-100">
                      ...
                      <div
                        className={`absolute bottom-4 left-4 z-20 w-12 h-12 rounded-2xl ${portal.color} flex items-center justify-center shadow-lg backdrop-blur-sm bg-white/90`}
                      >
                    ...
                    <CardContent className="p-8 flex flex-col flex-1 text-left">
                      ...
                      <Button
                        ...
                        className={`w-full rounded-full h-12 text-base font-medium group-hover:bg-primary group-hover:text-black transition-all duration-300 ${
                          portal.buttonVariant === "outline" ? "border-2" : ""
                        }`}
                      >
                        Enter Portal
